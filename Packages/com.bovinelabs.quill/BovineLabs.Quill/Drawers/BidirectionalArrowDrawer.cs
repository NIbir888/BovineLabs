// <copyright file="BidirectionalArrowDrawer.cs" company="BovineLabs">
...
namespace BovineLabs.Quill.Drawers
{
    ...
    internal struct BidirectionalArrowDrawer : IDrawer
    {
        public float3 X0;
        public float3 X1;
        public Color Color;
        ...
        public void Draw(ref DrawBuilder builder)
        {
            ...
            // Arrow at X0 (start) - pointing in opposite direction
            builder.DrawLine(this.X0, this.X0 - ((p - dir) * scale), this.Color);
            builder.DrawLine(this.X0, this.X0 + ((p + dir) * scale), this.Color);
            builder.DrawLine(this.X0, this.X0 - ((q - dir) * scale), this.Color);
            builder.DrawLine(this.X0, this.X0 + ((q + dir) * scale), this.Color);
        }
    }
}
