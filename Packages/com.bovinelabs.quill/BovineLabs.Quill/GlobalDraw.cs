...
namespace BovineLabs.Quill
{
    ...
    public static class GlobalDraw
    {
        ...
        /// <summary> <see cref="Drawer.BidirectionalArrow"/>. </summary>
        [Conditional("UNITY_EDITOR")]
        public static void BidirectionalArrow(float3 origin, float3 vector, Color color, float duration = 0f)
        {
#if UNITY_EDITOR
            DrawerImpl.BidirectionalArrow(ref Draw.Data, origin, vector, color, duration);
#endif
        }
        ...
        [Conditional("UNITY_EDITOR")]
        public static void AABB(AABB aabb, Color color, float duration = 0f)
        {
#if UNITY_EDITOR
            DrawerImpl.AABB(ref Draw.Data, aabb, color, duration);
#endif
        }
        ...
        /// <summary> <see cref="Drawer.SolidTriangles"/>. </summary>
        [Conditional("UNITY_EDITOR")]
        public static void SolidTriangles(NativeArray<float3x3> triangles, NativeArray<Color> color, float duration = 0f)
        {
#if UNITY_EDITOR
            DrawerImpl.SolidTriangles(ref Draw.Data, triangles, color, duration);
#endif
