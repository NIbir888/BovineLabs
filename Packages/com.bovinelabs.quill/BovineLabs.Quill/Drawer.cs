...
namespace BovineLabs.Quill
{
    ...
    public struct Drawer : IDrawWriter
    {
        ...
        [Conditional("BL_DEBUG")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void BidirectionalArrow(float3 origin, float3 vector, Color color, float duration = 0f)
        {
            DrawerImpl.BidirectionalArrow(ref this, origin, vector, color, duration);
        }
        ...
        [Conditional("BL_DEBUG")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void AABB(AABB aabb, Color color, float duration = 0f)
        {
            DrawerImpl.AABB(ref this, aabb, color, duration);
        }
        ...
        /// <summary> Draws a collection of solid triangles with individual colors. </summary>
        /// <param name="triangles"> Collection of triangles point. </param>
        /// <param name="color"> The Colors to draw with. </param>
        /// <param name="duration"> How long to draw this. </param>
        [Conditional("UNITY_EDITOR")]
        [Conditional("BL_DEBUG")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void SolidTriangles(NativeArray<float3x3> triangles, NativeArray<Color> color, float duration = 0f)
        {
            DrawerImpl.SolidTriangles(ref this, triangles, color, duration);
        }
    }
