...
namespace BovineLabs.Quill
{
    ...
    internal static class DrawerImpl
    {
        ...
        /// <summary> Draws a bidirectional arrow. </summary>
        /// <param name="drawer"> The drawer. </param>
        /// <param name="origin"> The starting point of the arrow. </param>
        /// <param name="vector"> The distance and direction vector of the tip from the origin. </param>
        /// <param name="color"> The Color to draw with. </param>
        ...
        [Conditional("UNITY_EDITOR")]
        [Conditional("BL_DEBUG")]
        public static void BidirectionalArrow<T>(ref T drawer, float3 origin, float3 vector, Color color, float duration = 0f)
            where T : unmanaged, IDrawWriter
        {
#if UNITY_EDITOR || BL_DEBUG
            if (!drawer.IsEnabled)
            ...
            drawer.Write(new DrawHeader(DrawType.BidirectionalArrow, duration));
            drawer.Write(new BidirectionalArrowDrawer
            {
                X0 = origin,
                X1 = origin + vector,
                Color = color,
        ...
        [Conditional("UNITY_EDITOR")]
        [Conditional("BL_DEBUG")]
        public static void AABB<T>(ref T drawer, AABB aabb, Color color, float duration = 0f)
            where T : unmanaged, IDrawWriter
        {
#if UNITY_EDITOR || BL_DEBUG
            Cuboid(ref drawer, aabb.Center, quaternion.identity, aabb.Size, color, duration);
#endif
        }
        ...
        [Conditional("UNITY_EDITOR")]
        [Conditional("BL_DEBUG")]
        public static void SolidTriangles<T>(ref T drawer, NativeArray<float3x3> triangles, NativeArray<Color> color, float duration = 0f)
            where T : unmanaged, IDrawWriter
        {
#if UNITY_EDITOR || BL_DEBUG
            if (!drawer.IsEnabled)
            ...
            Check.Assume(triangles.Length == color.Length);
