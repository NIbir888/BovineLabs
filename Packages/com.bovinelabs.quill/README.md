...
| draw.enabled                | Sets the global drawer enabled state.                                                             |
| draw.enabled-global         | Enable the global drawer in the editor.                                                           |
| draw.scene-switch           | Allow switching to scene view camera for culling when it has focus.                               |
| draw.draw-range             | Custom far clip plane for collider culling to help performance.                                   |
| draw.physics-cull           | Should physics colliders be culled by the game camera to help performance.                        |
| draw.physics-terrain_range  | Custom far distance for terrain collider culling to help performance.                             |
| draw.physics-static_color   | Color used for static physics collider debug drawing.                                             |
| draw.physics-dynamics_color | Color used for dynamic physics collider debug drawing.                                            |
...
Note: When running in editor world GlobalDraw is always enabled to support editor tooling.
